...
class CashPayment extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(S.of(context).pay_cash),
      ),
      floatingActionButton: Container(
        ...
        child: Container(
          // width: 200,
          child: appButton(S.of(context).exit.toUpperCase(), onpress: () {
      ...
      body: Container(
        child: ListView(
          ...
          children: [
            RichText(
              text: TextSpan(
                text: S.current.customer_service_info_message,
                style: TextStyle(
                  fontSize: 16,
                  color: Colors.black,
